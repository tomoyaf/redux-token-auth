...
import {
    ...
    SIGNIN_REQUEST_FAILED, SIGNIN_REQUEST_SENT, SIGNIN_REQUEST_SUCCEEDED, SIGNOUT_REQUEST_FAILED,
    SIGNOUT_REQUEST_SENT, SIGNOUT_REQUEST_SUCCEEDED, User, UserAttributes,
