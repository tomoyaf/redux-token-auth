...
export type SIGNOUT_LOCAL_REQUEST = "redux-token-auth/SIGNOUT_LOCAL_REQUEST";
export const SIGNOUT_LOCAL_REQUEST: SIGNOUT_LOCAL_REQUEST =
  "redux-token-auth/SIGNOUT_LOCAL_REQUEST";
...
export type RESET_ERRORS = "redux-token-auth/RESET_ERRORS";
export const RESET_ERRORS: RESET_ERRORS = "redux-token-auth/RESET_ERRORS";
